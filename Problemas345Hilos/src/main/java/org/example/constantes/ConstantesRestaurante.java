...
public class ConstantesRestaurante {
    ...
    public static String PEDIDO = "%tT 🍽️ Cliente-%d ha pedido: %s%n";
    public static String ERROR_CLIENTE = "Error en el cliente%n";
    public static int TIEMPO_ESPERA_CLIENTE = 2000;

    public static String COCINADO = "✅ Cocinero %s ha terminado de cocinar: %s%n";
    public static String ERROR_COCINERO = "Error en el cocinero%n";

    public static String NO_MESAS_LIBRES = "❌ Cliente-%d se va, no hay mesas libres%n";
